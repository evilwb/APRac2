...
# Weapons
CLANK_ZAPPER = WeaponData(101, "Clank Zapper", 9, icon_id=0xEA99, power=0, max_ammo=30)
BOMB_GLOVE = WeaponData(102, "Bomb Glove", 12, icon_id=0xEA79, power=4, max_ammo=40)
VISIBOMB_GUN = WeaponData(103, "Visibomb Gun", 14, icon_id=0xEA7D, power=4, max_ammo=20)
SHEEPINATOR = WeaponData(104, "Sheepinator", 16, icon_id=0xEA77, power=4)
DECOY_GLOVE = WeaponData(105, "Decoy Glove", 17, icon_id=0xEA7B, power=0, max_ammo=20)
TESLA_CLAW = WeaponData(106, "Tesla Claw", 18, icon_id=0xEA7A, power=4, max_ammo=300)
CHOPPER = WeaponData(107, "Chopper", 22, icon_id=0xEA66, power=4, max_ammo=35)
PULSE_RIFLE = WeaponData(108, "Pulse Rifle", 23, icon_id=0xEA68, power=5, max_ammo=8)
SEEKER_GUN = WeaponData(109, "Seeker Gun", 24, icon_id=0xEA6B, power=5, max_ammo=25)
HOVERBOMB_GUN = WeaponData(110, "Hoverbomb Gun", 25, icon_id=0xEA72, power=9, max_ammo=10)
BLITZ_GUN = WeaponData(111, "Blitz Gun", 26, icon_id=0xEA67, power=4, max_ammo=40)
MINIROCKET_TUBE = WeaponData(112, "Minirocket Tube", 27, icon_id=0xEA70, power=7, max_ammo=20)
PLASMA_COIL = WeaponData(113, "Plasma Coil", 28, icon_id=0xEA71, power=8, max_ammo=10)
LAVA_GUN = WeaponData(114, "Lava Gun", 29, icon_id=0xEA69, power=6, max_ammo=200)
LANCER = WeaponData(115, "Lancer", 30, icon_id=0xEA64, power=3, max_ammo=200)
SYNTHENOID = WeaponData(116, "Synthenoid", 31, icon_id=0xEA6D, power=7, max_ammo=12)
SPIDERBOT_GLOVE = WeaponData(117, "Spiderbot Glove", 32, icon_id=0xEA6E, power=4, max_ammo=8)
BOUNCER = WeaponData(118, "Bouncer", 37, icon_id=0xEA73, power=8, max_ammo=25)
MINITURRET_GLOVE = WeaponData(119, "Miniturret Glove", 41, icon_id=0xEA6A, power=5, max_ammo=25)
GRAVITY_BOMB = WeaponData(120, "Gravity Bomb", 42, icon_id=0xEA65, power=3, max_ammo=8)
ZODIAC = WeaponData(121, "Zodiac", 43, icon_id=0xEA76, power=10, max_ammo=4)
RYNO_II = WeaponData(122, "RYNO II", 44, icon_id=0xEA6C, power=10, max_ammo=100)
SHIELD_CHARGER = WeaponData(123, "Shield Charger", 45, icon_id=0xEA74, power=9, max_ammo=5)
